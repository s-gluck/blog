...
I created a Radar Plot intended for the scientific commmunity to visualize the same data from this Alluvial Plot. Check out [my Radar Plot post](add post link here) to see an alternative visualization of the same data. 
